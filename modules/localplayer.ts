...
import {g_dispatcher, ScheduledEvent} from "./eventdispatcher";
...
*/
    ...
    setPendingGame(pending: boolean): void {
    ...
    getSkillBaseLevel(skill: Skill): number {
        return this.m_skillsBaseLevel[skill];
    }

    getSkillLevelPercent(skill: Skill): number {
    ...
    getInventoryItem(inventory: InventorySlot): Item {
...
//callLuaField("onCancelWalk", direction);
    ...
    stopWalk(): void {
        super.stopWalk(); // will call terminateWalk
    ...
    updateWalkOffset(totalPixelsWalked: number): void {
